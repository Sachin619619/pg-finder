      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 w-full overflow-x-hidden">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 bg-[#1a1a1a] rounded-2xl flex items-center justify-center shadow-lg shadow-black/10">
          ...
          <span className="px-3 py-1.5 bg-[#1a1a1a] text-white text-[10px] font-bold uppercase tracking-wider rounded-xl">Admin</span>
        </div>
          ...
          {tabs.map((t) => (
            <button
              ...
              className={`flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-semibold transition-all capitalize shrink-0 ${
                tab === t.key ? "bg-[#1a1a1a] text-white shadow-lg shadow-black/15" : "bg-gray-100 text-[#666] hover:bg-gray-100 border border-gray-200/60"
              }`}
            >
          ...
          <>
              ...
              <div className="space-y-5">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5">
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    <div className="bg-gray-100 ring-1 ring-gray-200 rounded-xl p-3.5 text-center">
            ...
            {tab === "listings" && (
              <div className="space-y-4">
                {editingListing && (
                  <div className="premium-card !rounded-2xl p-5 border-2 border-[#1a1a1a] mb-6">
