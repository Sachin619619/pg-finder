    ...
    <>
      ...
      <main id="main-content" className="flex-1 overflow-x-hidden">
        ...
        <section className="bg-[#F0EADD] pt-44 pb-24 sm:pt-56 sm:pb-32 relative overflow-hidden">
          {/* Decorative elements */}
          <div className="absolute top-20 left-10 w-64 h-64 bg-[#1B5E3B]/5 rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-10 w-80 h-80 bg-[#d4a574]/10 rounded-full blur-3xl" />
          <div className="absolute top-1/3 right-1/4 w-2 h-2 bg-[#1B5E3B]/20 rounded-full animate-float" />
          <div className="absolute top-1/2 left-[16.67%] w-3 h-3 bg-[#d4a574]/20 rounded-full animate-float" style={{animationDelay: '2s'}} />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              {/* Hero heading */}
              <h1 className="font-serif text-[3.2rem] sm:text-[5rem] lg:text-[5.5rem] font-normal mb-7 leading-[1.05] tracking-tight">
                <span className="text-[#1a1a1a]">Find your</span>
                <br />
                <em className="bg-gradient-to-r from-[#1B5E3B] to-[#2d8a5e] bg-clip-text text-transparent">perfect stay</em>
                <br />
                <span className="text-[#1a1a1a]">in Bangalore</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto relative">
                <div className="absolute -inset-4 bg-[#1B5E3B]/5 rounded-3xl blur-xl" />
                ...
                <button
                  ...
                  className="bg-[#1a1a1a] text-white py-4 px-10 rounded-full font-medium text-sm hover:shadow-[0_0_20px_rgba(27,94,59,0.3)] transition-all duration-300 hover:opacity-90 whitespace-nowrap"
                >
                  Search PGs
                </button>
                </div>
              ...
              {/* Popular area chips */}
              <div className="flex flex-wrap justify-center gap-2 mt-6 max-w-xl mx-auto stagger-children">
            ...
            <div className="flex items-center gap-4 max-w-xs mx-auto mb-8">
              ...
              <span className="text-[10px] font-semibold text-black/30 uppercase tracking-[0.2em]">Trusted by thousands</span>
        ...
        {/* ===== TRUST MARQUEE ===== */}
        <section className="bg-[#1B5E3B] py-4 overflow-hidden">
            ...
            {[...Array(2)].map((_, setIdx) => (
              <div key={setIdx} className="flex items-center gap-12">
                {[
                  ...
                  <span key={`${setIdx}-${item}`} className="text-sm font-medium text-white/60 flex items-center gap-2">
                    {item}
        ...
        {/* ===== OWNER DASHBOARD LANDING ===== */}
        <OwnerDashboardLanding />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-10 mb-16">
              <div className="sm:col-span-2">
                <span className="font-serif text-3xl text-white block leading-none">Castle</span>
                <p className="text-white/50 text-sm mt-2">Bangalore&apos;s most trusted PG finder platform</p>
                <p className="text-sm leading-relaxed max-w-xs text-white/40 mt-4 mb-6">
                  Discover premium PG accommodations, hostels, and co-living spaces across Bangalore&apos;s best neighborhoods.
                </p>
                {/* Social links */}
                <div className="flex items-center gap-3">
                  <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all cursor-pointer">
                  ...
                  <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all cursor-pointer">
                  ...
                  <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all cursor-pointer">
              ...
              <div>
                <h4 className="text-white font-semibold text-sm uppercase tracking-wider mb-4">Popular Areas</h4>
            ...
            <div className="border-t border-white/10 pt-6 mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-white/30 text-xs">&copy; 2026 Castle. All rights reserved.</p>
              <div className="flex items-center gap-4">
                <a href="/privacy" className="text-white/30 text-xs hover:text-white transition-colors">Privacy Policy</a>
                <span className="text-white/20">·</span>
                <a href="/terms" className="text-white/30 text-xs hover:text-white transition-colors">Terms of Service</a>
              </div>
              <p className="text-white/30 text-xs flex items-center gap-1.5">
                Made with <span className="text-red-400">&hearts;</span> in Bangalore
              </p>
            </div>
          </div>
        </footer>
