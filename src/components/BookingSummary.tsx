...
export default function BookingSummary({
  ...
  return (
    <div className="bg-[#FFFDF9] rounded-3xl shadow-lg border border-black/[0.04] p-5">
      ...
      <div className="space-y-2 mb-4">
        ...
        <div className="border-t border-black/8 pt-2 flex items-center justify-between">
          ...
          <span className="text-lg font-bold text-[#1B5E3B]">₹{totalFirstPayment.toLocaleString()}</span>
        </div>
      </div>
      ...
      <div className="bg-[#FFFDF9]/70 rounded-xl p-4">
        <div className="flex items-center justify-between mb-2">
          <span className="font-serif text-sm font-semibold text-[#666]">Total Contract Value</span>
