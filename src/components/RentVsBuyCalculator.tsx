  ...
  return (
    <div className="bg-gradient-to-br from-violet-50 to-indigo-50 border border-violet-100 rounded-2xl p-5">
      ...
      <div className="space-y-3 mb-4">
        ...
        <div>
          <label className="text-xs font-semibold text-gray-600 mb-1 block">Years Planning to Stay</label>
          <input
            type="range"
            min="1"
            max="5"
      ...
      <div className="space-y-2">
        <div className="flex justify-between p-2 bg-white/60 rounded-lg">
          <span className="text-xs text-gray-600">Total Rent Paid</span>
          <span className="text-sm font-bold text-gray-900">₹{rentPaid.toLocaleString()}</span>
        </div>
        <div className="flex justify-between p-2 bg-white/60 rounded-lg">
          <span className="text-xs text-gray-600">Est. 1BHK Cost</span>
