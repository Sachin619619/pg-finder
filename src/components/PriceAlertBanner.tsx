...
export default function PriceAlertBanner() {
  ...
  return (
    <section className="py-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-500 rounded-3xl p-8 sm:p-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              ...
              <button type="submit" className="px-8 py-3 bg-white text-violet-700 rounded-xl font-semibold text-sm hover:bg-gray-100 transition whitespace-nowrap">
                Alert Me
              </button>
            </form>
          </div>
