      ...
      >
        ...
        <div className={`relative h-52 ${hasImage ? "bg-gray-200" : `bg-gradient-to-br ${gradient}`} overflow-hidden`}>
          ...
          <div className="absolute bottom-3 right-3 z-10 flex items-center gap-1.5">
            <a
              href={`https://wa.me/?text=${encodeURIComponent(`Check out this PG: ${pg.name} in ${pg.area} - ₹${pg.price.toLocaleString()}/month ⭐${pg.rating} — View on PG Finder: https://pg-finder-eight.vercel.app/listing/${pg.id}`)}`}
              target="_blank"
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <span className="pill bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400 !text-[11px] border border-gray-100 dark:border-gray-700">
              {pg.type === "single" ? "🛏️ Single" : pg.type === "double" ? "🛏️ Double" : "🛏️ Triple"}
            </span>
            {pg.foodIncluded && (
