  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 right-4 md:hidden z-40 w-14 h-14 bg-[#1B5E3B] text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all active:scale-95"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden" onClick={() => setOpen(false)}>
          ...
          <div
            className="absolute bottom-0 left-0 right-0 max-h-[85vh] bg-[#FFFDF9] rounded-t-3xl overflow-y-auto animate-slide-up shadow-2xl"
