              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-2">
                  {selectedPG.amenities.slice(0, 3).map((a) => (
                    <span
                      key={a}
                      className="text-[10px] px-2 py-0.5 bg-gray-100 text-[#1a1a1a] rounded-full"
                    >
                      {a}
                    </span>
                  ))}
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1 mt-3 text-sm text-[#1a1a1a] font-medium hover:underline"
                >
                  View Details
                  <svg
