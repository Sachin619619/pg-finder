...
export default function GhibliShowcase() {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-[#F4EDD9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <FadeIn delay={100} className="lg:col-span-2">
              <div className="group relative rounded-3xl overflow-hidden bg-[#FFFAEB] border border-[#e8e0cc] h-[380px] cursor-pointer hover:border-black/20 transition-all">
            ...
            <FadeIn delay={300} className="lg:col-span-3">
              <div className="group relative rounded-3xl overflow-hidden bg-[#FFFAEB] border border-[#e8e0cc] h-[340px] cursor-pointer hover:border-black/20 transition-all">
                <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105">
                  <Image
