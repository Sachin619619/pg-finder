    ...
    <section className="py-20 bg-[#0a0a0a] text-white overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-black rounded-xl font-semibold text-sm hover:bg-[#EDE8DE] transition-colors">
