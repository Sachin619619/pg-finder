                    ...
                    <div className="relative ml-2">
                      ...
                      {userMenuOpen && (
                        <div role="menu" className="absolute right-0 top-12 w-60 bg-[#faf6ec] rounded-2xl shadow-2xl shadow-black/10 border border-[#e8e0cc] py-1.5 z-50 animate-slide-up">
                          ...
                          <Link href="/my-visits" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-2.5 px-3 py-2.5 text-sm text-[#333] rounded-xl hover:bg-[#ebe4d0] transition-all">
